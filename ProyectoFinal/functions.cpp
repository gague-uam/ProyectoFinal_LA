...
{
    std::regex localPointsRegex("^[0-9]+$");
    return std::regex_match(localPointsStr, localPointsRegex);
}

bool isVisitPointsValid(const std::string &visitPointsStr)
{
    std::regex visitPointsRegex("^[0-9]+$");
    return std::regex_match(visitPointsStr, visitPointsRegex);
}
